...
public class NMSPackets implements NMSPacketBuilder {
    ...
    @Override
    public PacketWrapper buildArmorStandHeadPosePacket(int entityId, float xDegrees, float yDegrees, float zDegrees) {
        return new ArmorStandHeadPoseWrapper(entityId, xDegrees, yDegrees, zDegrees);
    }
