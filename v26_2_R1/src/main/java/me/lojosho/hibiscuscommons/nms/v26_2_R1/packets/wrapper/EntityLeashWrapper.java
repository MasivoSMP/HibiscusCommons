...
public class EntityLeashWrapper implements PacketWrapper {
    ...
    public Object toNativePacket() {
        ...
        Entity entity1 = new ArmorStand(net.minecraft.world.entity.EntityTypes.ARMOR_STAND, level);
        Entity entity2 = new ArmorStand(net.minecraft.world.entity.EntityTypes.ARMOR_STAND, level);
